    ...
    >
      <div className="banner-left col-md-6 p-3">
        ...
        <p>
          ...
          possimus quam exercitationem neque minima corrupti nobis sapiente
          perferendis iusto vitae ipsa rem, explicabo sit est numquam. Repellat
          voluptas excepturi natus placeat minima neque quos fugiat qui in
          obcaecati, distinctio maiores, consequatur ducimus molestiae debitis
          laudantium eum pariatur id, expedita sint!
        </p>
